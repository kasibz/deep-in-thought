...
const Tenant = () => {
    ...
    const [isPayByCreditCardDialogOpen, setIsPayByCreditCardDialogOpen] = useState(false); 
        ...
        >
          Rent Due!
            ...
            <div className="account-balance">
                ...
                <Button variant="outlined" fullWidth onClick={onClickOpenPayByCreditCardDialog}>Pay Rent</Button>
